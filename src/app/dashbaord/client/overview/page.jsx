      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {cardsData.map((card, index) => (
          <div
            ...
            className="flex justify-between items-center rounded-lg px-4 py-6"
          >
            <div className="flex flex-col">
              <span className="text-2xl font-semibold">{card.jobs}</span>
              <span className="text-gray-500 text-[22px]">{card.title}</span>
            </div>
            <Image
              src={card.image}
              width={68}
